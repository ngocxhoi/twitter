  ...
  <div>
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="w-full p-2 relative z-0">
        <UTextarea
          ...
          variant="none"
          :ui="{ base: 'border border-transparent focus:border-blue-500' }"
        />
      </div>
    </div>
    ...
    <div class="p-4 pl-16">
      <img
        ...
        v-if="inputImageUrl"
        alt=""
        class="border rounded-2xl border-white dark:border-gray-700"
      />
    ...
    <div class="flex p-2 pl-14">
      ...
      <div class="ml-auto">
        <UButton size="sm" :disabled="isDisabled" @click="handleFormSubmit">
